...
author: "S.Caetano, N. Moon, and S. Schwartz"
...
- You might be wondering how can I record this? One way to do this would be to schedule a Zoom meeting and record yourself in it. You can "Record the video to the cloud" (or directly on your computer). Several file types will be saved, including a video version, and one that is just a voice recording. 
 
- You MUST upload a link (aka a URL) to your recording for your TA to watch your video.  Paste the URL directly into your answers to this problem set. ONLY links will be reviewed by the TA, we are not accepting mp4 or clip uploads. You can provide the zoom cloud link from your recording if you've chosen "Record to the cloud". Or, alternatively, you can upload your video to mymedia, MS Stream, YouTube, etc., though uploading/processing can be slow, so give yourself plenty of time to prepare this.

  - NOTE: Your link must NOT be password protected (which is often the default in Zoom sharing). Please ensure that there is NO password protection on the video/link. You can test this by seeing if you can open the file in a new browser or in incognito mode.  Files which cannot be accessed by the TA just "clicking the link" and "watching the video" (without entering a password) will receive a 0.
